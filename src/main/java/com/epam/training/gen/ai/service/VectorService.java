...
public class VectorService {
    ...
    public Collections.CollectionOperationResponse createCollection(String collectionName, AddCollectionRequest request) throws ExecutionException, InterruptedException {
        return qdrantClient.createCollectionAsync(collectionName, Collections.VectorParams.newBuilder().setDistance(Collections.Distance.Cosine).setSize(request.getSize()).build()).get();
    }
     ...
     */
    public void processAndSaveText(String collectionName, String text) throws ExecutionException, InterruptedException {
     ...
     * @throws InterruptedException if the thread is interrupted during execution
     */
    public List<Points.ScoredPoint> search(String collectionName, String text) throws ExecutionException, InterruptedException {
     ...
     */
    private void saveVector(String collectionName, ArrayList<Points.PointStruct> pointStructs) throws InterruptedException, ExecutionException {
